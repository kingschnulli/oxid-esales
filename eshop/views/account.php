 ...
 * @version   SVN: $Id: account.php 28043 2010-06-01 13:44:44Z arvydas $
 */
...
class Account extends oxUBase
{
    ...
    public function render()
    {
        ...
        if ( !$oUser || ( $oUser && !$oUser->oxuser__oxpassword->value ) ||
             ( $this->isActive( 'login' ) && $oUser && $this->confirmTerms() ) ) {
    ...
    {
        return $this->isActive( 'login' ) ? $this->_sThisAltLoginTemplate : $this->_sThisLoginTemplate;
    }
