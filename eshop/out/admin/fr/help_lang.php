...
'HELP_SHOP_SYSTEM_OTHERCOUNTRYORDER'            =>  'Définissez ici si des commandes peuvent être passées dans des pays pour lesquels aucun mode de livraison n\'a été défini:' .
                                                    '<ul><li>Si cette fonction est activée, les utilisateurs peuvent commander: Les utilisateurs seront notifiés manuellement des coûts de transport pour leur commande.</li>' .
                                                    '<li>Si cette fonction est désactivée, les utilisateurs de pays pour lesquels aucun mode de livraison n\'a été défini ne pourront pas commander.</li></ul>',
...
'HELP_SHOP_SYSTEM_DEFAULTIMAGEQUALITY'          =>  'Valeurs recommandées entre 40 et 80:<br>' .
                                                    '<ul><li>En deçà de 40, la compression de vient visible et les images sont troubles.</li>'.
                                                    '<li>Au-delà de 80 les améliorations visuelles sont imperceptibles, en revanche la taille des images augmente de manière significative.</li></ul><br>'.
...
'HELP_SHOP_SYSTEM_VARIANTPARENTBUYABLE'         =>  'Ce paramètre permet de définir si les produits parents peuvent être achetés:' .
                                                    '<ul><li>Lorsque ce paramètre est activé, les produits parents peuvent être achetés également.</li>' .
                                                    '<li>Lorsque ce paramètre est désactivé, seules les variantes du produit peuvent être achetées.</li></ul>',
...
'HELP_SHOP_CONFIG_ORDEROPTINEMAIL'              =>  'Lorsque le double-opt-dans est actif, les utilisateurs recoivent un eMail avec un lien de confirmation lorsqu\'ils s\'abonnent à la Newsletter. L\'inscription n\'est valide que lorsque la confirmation à été effectuée.<br>' .
                                                    'Le Double-opt-dans protège les utilisateurs d\'abonnements non sollicités. Sans double-opt-dans, n\'importe quelle adresse eMail peut être utilisée pour la Newsletter. Avec le double-opt-dans, le propriétaire de l\'adresse doit confirmer sont inscription.',

'HELP_SHOP_CONFIG_BIDIRECTCROSS'                =>  'Avec le Cross-selling vous pouvez proposer des produits complémentaires à un produit: Si par exemple des pneus sont définis comme produits complémentaires à une voiture, les pneus sont affichés avec la voiture.<br>' .
                                                    'Si le Cross-selling bidirectionnel est activé, il fonctionnera dans les deux sens.',

'HELP_SHOP_CONFIG_STOCKONDEFAULTMESSAGE'        =>  'Pour chaque produit, vous pouvez définir un message si le produit est en stock.<br>' .
                                                    'Lorsque ce paramètre est activé, un message générique est affiché si aucun message spécifique n\'a été défini. Le message générique <span class="filename_filepath_or_italic">Produit en stock</span> est affiché.',

'HELP_SHOP_CONFIG_STOCKOFFDEFAULTMESSAGE'       =>  'Pour chaque produit, vous pouvez définir un message si le produit n\'est pas en stock.<br>' .
                                                    'Lorsque ce paramètre est activé, un message générique est affiché si aucun message spécifique n\'a été défini. Le message générique <span class="filename_filepath_or_italic">Produit en rupture de stock. En cours de réapprovisionnement</span> est affiché.',
...
'HELP_SHOP_CONFIG_OVERRIDEZEROABCPRICES'        =>  'Vous pouvez définir des prix spéciaux pour des utilisateurs spécifiques: Pour cela, dans chaque produit vous pouvez définir des prix A, B et C. Si les utilisateurs appartiennent au groupe <span class="filename_filepath_or_italic">Price A</span>, Le prix A sera affiché à la place du prix normal.<br>' .
                                                    'Lorsque ce paramètre est actif, le prix normal est utilisé si aucun prix A, B ou C n\'a été défini.<br>' .
                                                    'A n\'activer que si vous utilisez des prix A, B et C prices.',

'HELP_SHOP_CONFIG_SEARCHFIELDS'                 =>  'Ici, vous pouvez définir les champs dans lesquels la recherche sera effective. Saisissez un champ par ligne.<br>' .
                                                    'Les champs fréquemment définis sont:' .
                                                    '<ul><li>oxtitle = Titre</li>' .
                                                    '<li>oxshortdesc = Description courte</li>' .
                                                    '<li>oxsearchkeys = Mots clés de recherche</li>' .
                                                    '<li>oxartnum = Réf produit</li>' .
                                                    '<li>oxtags = Tags</li></ul>',

'HELP_SHOP_CONFIG_SORTFIELDS'                   =>  'Ici, vous pouvez définir les champs utilisés pour les tris dans les listes produits. Saisissez un champ par ligne.<br>' .
                                                    'Les champs fréquemment définis sont:' .
                                                    '<ul><li>oxtitle = Titre</li>' .
                                                    '<li>oxprice = Prix</li>' .
...
'HELP_SHOP_CONFIG_MUSTFILLFIELDS'               =>  'Ici, vous pouvez définir les champs obligatoires pour la création d\'un utilisateur. Saisissez un champ par ligne.<br>' .
                                                    'Les champs fréquemment définis sont:' .
                                                    '<ul><li>oxuser__oxfname = Prénom</li>' .
                                                    ...
                                                    '<li>oxuser__oxfon = Téléphone</li></ul><br>' .
                                                    'Vous pouvez également définir des champs obligatoires lors de l\'utilisation d\'une adresse de livraison différente. Les champs fréquemment définis sont:' .
                                                    '<ul><li>oxaddress__oxfname = Prénom</li>' .
                                                    ...
                                                    '<li>oxaddress__oxfon = Téléphone</li></ul>',

'HELP_SHOP_CONFIG_USENEGATIVESTOCK'             =>  'Le paramètre <span class="navipath_or_inputname">Autoriser les valeurs de stock négatives</span> vous permet de définir comment gérer vos stocks:<br>' .
                                                    '<ul><li>Lorsque ce paramètre est activé, des niveaux de stocks négatifs sont calculés.</li>' .
                                                    '<li>Lorsque ce paramètre est désactivé, la valeur du stock ne descend jamais en dessous de 0.</li></ul>',
...
'HELP_SHOP_CONFIG_LOAD_DYNAMIC_PAGES'           =>  'Si cette fonction est activée, des informations additionnelles à propos des produits OXID sont affichées dans le menu. Ex: à propos d\'OXID eFire.',
...
'HELP_SHOP_CONFIG_DISABLEONLINEVATIDCHECK'      =>  'La validation en ligne du numéro de TVA est effectuée si un client de la zone EURO renseigne un numéro de TVA lors d\'une commande. Si le numéro de TVA renseigné est valide, la TVA ne sera pas calculée sur la commande.<br>'.
                                                    'Si cette fonction n\'est pas activée, le taux de TVA applicable est utilisé.',
...
'HELP_SHOP_CONFIG_BASKETEXCLUDE'                =>  'Autorise la mise au panier de produits d\'une seule catégorie (Principale). Si un changement de catégorie est ' .
                                                    'détecté, l\'utilisateur se vera demandé de finaliser sa commande ou bien de continuer son shopping ' .
                                                    '(dans le seuxième cas, le panier sera vidé). Cette fonctionnalité est à utiliser conjointement avec ' .
                                                    ' une structure de catégories proprement organisée.',

'HELP_SHOP_CONFIG_BASKETRESERVATION'            =>  'Lorsque cette fonctionnalité est désactivée, eShop diminue la quantité en stock du produit immédiatement ' .
                                                    'lorsque la commande est confirmée et le processus de commande terminé.<br><br> ' .
                                                    'Lorsque activée, cette fonctionnalité permet : la réduction du stock de produit ' .
                                                    'temporairement <b>réservé</b> lors de la mise au panier. La réservation est annulée '.
                                                    'lorsque la commande est passée ou à l\'expiration du panier.',
...
'HELP_SHOP_CONFIG_INVITATION'                   =>  'Les invitations sont utiliser pour inviter ' .
                                                    'ses amis à se connecter sur la boutique et gagner des points.',

'HELP_SHOP_CONFIG_POINTSFORINVITATION'          =>  'Le montant de points gagnés par un utilisateur invité par un utilisateur existant.' .
                                                    'L\'invité doit s\'enregistrer pour collecter ces points.' .
                                                    'Les points collectés sont enregistrés dans la fiche client et peuvent être utilisés par le gestionnaire de la boutique comme il l\'entend.',

'HELP_SHOP_CONFIG_POINTSFORREGISTRATION'        =>  'Le montant de points gagnés par un utilisateur ayant invité une personne. ' .
                                                    'L\'utilisateur reçoit des points uniquement si son invité s\'inscrit effectivement dans la boutique.' .
                                                    'Les points collectés sont enregistrés dans la fiche client et peuvent être utilisés par le gestionnaire de la boutique comme il l\'entend.',

'HELP_SHOP_CONFIG_SHOP_CONFIG_FACEBOOKAPPID'    =>  'Pour connecter votre boutique à Facebook vous devez saisir votre Application ID. ' .
                                                    'Un guide pour la connexion de votre boutique à Facebook est accessible ici : ' .
                                                    '<a href="http://wiki.oxidforge.org/Tutorials/Connecting_website_to_facebook" target="_blank" target="_blank">tutoriel (anglais)</a>.',

'HELP_SHOP_CONFIG_SHOP_CONFIG_FBSECRETKEY'      =>  'Pour assurer la sécurité des connexions avec Facebook, vous devez ' .
                                                    'saisir la clé de sécurité obtenue lors de l\'enregistrement de votre site auprès de ' .
...
'HELP_SHOP_CONFIG_FBLIVESTREAM'                 =>  'Live stream permet à vos utilisateurs de partager leurs commentaires et activité en temps réél sur votre site.',

'HELP_SHOP_CONFIG_FBINVITE'                     =>  'Affiche la liste d\'amis Facebook de vos utilisateurs pour leur permettre de les inviter à se connecter sur votre boutique.',

'HELP_SHOP_CONFIG_FBSHARE'                      =>  'Affiche le bouton "Facebook share" sur votre boutique.',

'HELP_SHOP_CONFIG_FBLIKE'                       =>  'Permet à vos utilisateurs d\'établir des connexions sur vos pages et partager ces contenus avec leurs amis sur Facebook en un clic.',
...
'HELP_SHOP_MALL_MALLMODE'                       =>  'Définissez ici ce qui est affiché en page d\'accueil de votre boutique:' .
                                                    '<ul><li><span class="navipath_or_inputname">Afficher la liste des boutiques</span>: Une page listant les boutiques disponibles est affichée.</li>' .
                                                    '<li><span class="navipath_or_inputname">Afficher la page d\'accueil de la boutique principale</span>: La page d\'accueil du site principal est affichée normalement.</li></ul>',
...
'HELP_SHOP_PERF_NEWESTARTICLES'                 =>  'Un listes des produits récents est affichée dans <span class="filename_filepath_or_italic">Derniers arrivages!</span>. Vous pouvez spécifier ici comment est gérée cette liste:' .
                                                    '<ul><li><span class="userinput_or_code">inactive</span>: La liste n\'est pas affichée.</li>' .
                                                    '<li><span class="userinput_or_code">manuel</span>: Vous définissez le contenu dans <span class="navipath_or_inputname">Information clients -> Promotions -></span> dans la promotion <span class="filename_filepath_or_italic">Derniers arrivages!</span>.</li>' .
                                                    '<li><span class="userinput_or_code">automatique</span>: Les produits sont calculés automatiquement.</li></ul>',

'HELP_SHOP_PERF_TOPSELLER'                      =>  'Une liste des produits les plus commandés est affichée dans <span class="filename_filepath_or_italic">Best sellers</span>. Vous pouvez spécifier ici comment est gérée cette liste:' .
                                                    '<ul><li><span class="userinput_or_code">inactive</span>: La liste n\'est pas affichée.</li>' .
                                                    '<li><span class="userinput_or_code">manual</span>: Vous définissez le contenu dans <span class="navipath_or_inputname">Information clients -> Promotions -></span> dans la promotion <span class="filename_filepath_or_italic">Best sellers</span>.</li>' .
                                                    '<li><span class="userinput_or_code">automatic</span>: Les produits sont calculés automatiquement.</li></ul>',
...
'HELP_SHOP_PERF_LOADREVIEWS'                    =>  'Les utilisateurs peuvent noter et commenter les produits. Si ce paramètre est activé, les commentaires et notations existants sont chargés et affichés dans la fiche produit.',
...
'HELP_SHOP_PERF_LOADATTRIBUTES'                 =>  'Normalement, les attributs ne sont achargés que dans la fiche produit. Si ce paramètre est activé, les attributs seront toujours chargés avec un produit.<br>' .
                                                    'Ce paramètre peut être utile lorsque vous souhaitez adapter les templates. Ex: Afficher les attributs dans les listes produits également.',
...
'HELP_SHOP_SEO_TITLEPREFIX'                     =>  'Chaque page dispose d\'un titre. ce titre est affiché en haut de la fenêtre du navigateur. Avec <span class="navipath_or_inputname">Prefixe Titre</span> et <span class="navipath_or_inputname">Suffixe Titre</span> vous pouvez ajouter du texte avant et après le titre:<br>' .
                                                    '<ul><li>Dans <span class="navipath_or_inputname">Préfixe Titre</span>, saisissez le texte à afficher avant le titre de la page.</li></ul>',

'HELP_SHOP_SEO_TITLESUFFIX'                     =>  'Chaque page dispose d\'un titre. ce titre est affiché en haut de la fenêtre du navigateur. Avec <span class="navipath_or_inputname">Prefixe Titre</span> et <span class="navipath_or_inputname">Suffixe Titre</span> vous pouvez ajouter du texte avant et après le titre:<br>' .
                                                    '<ul><li>Dans <span class="navipath_or_inputname">Suffixe Titre</span>, saisissez le texte à afficher après le titre de la page.</li></ul>',

'HELP_SHOP_SEO_IDSSEPARATOR'                    =>  'Le séparateur est utilisé lorsque le nom des catégories et des produits est composé de plusieurs mots Le séparateur sera utilisé à la place des espaces. ex: www.youreshop.com/category-name-of-several-words<br>' .
                                                    'Si aucun séparateur n\'est défini, - sera utilisé.',
...
'HELP_SHOP_SEO_REPLACECHARS'                    =>  'Des caractères accentués, comme le ù français doivent être enelvés des URLs SEO, car ils peuvent poser problème. Vous pourrez définir ici comment ces caractères seront remplacés. La syntaxe est <code>caractère spécial => caractère de substitution</code>, ex: <code>Ü => Ue</code>.<br>' .
                                                    'Pour l\'allemand, les caractères de substitution sont déjà définis.',
...
'HELP_SHOP_MAIN_PRODUCTIVE'                     =>  'Tant que ce paramètre n\'est <span class="warning_or_important_hint">pas</span> actif, les informations relatives aux temps d\'execution et au debuggage sont affichées en pied de page. Ces informations sont très utilies lors de la customization de la boutique.<br>' .
                                                    '<span class="warning_or_important_hint">Activez ce paramètres lorsque vous passez en production. Dans ce cas, seul le contenu de la boutique sera affiché à vos utilisateurs.</span>',

'HELP_SHOP_MAIN_ACTIVE'                         =>  'Avec <span class="navipath_or_inputname">Actif</span> vous pouvez activer ou désactiver complètement votre boutique. Si votre boutique est désactivée, a message expliquent que la boutique est temporairement inaccessible est affiché à vos utilisateurs. Ce paramètre peut être utile dans le cadre d\'opérations de maintenance.',
...
'HELP_ARTICLE_EXTEND_ISCONFIGURABLE'            =>  'Si le produit est customizable, un champ de saisie additionel est affiché sur la fiche produit et dans le panier d\'achats. Les clients pourront alors saisir un texte pour customiser le produit.<br><br>'.
                                                    'Un exemple typique de l\'utilité de cette fonction pour la vente de tee-shirts qui peuvent être imprimés avec un message personnalisé.',

'HELP_ARTICLE_PICTURES_ICON'                    =>  'Les icônes sont les plus petits visuels produits. Ils sont utilisés entre autres dans le panier.<br>'.
                                                    'Transférer une image icône remplacera l\'image actuelle générée depuis la première image produit.<br>' .
                                                    'Après transfert, le nom de l\'image est affiché dans icône. Si aucune icône n\'a été transférée, --- est affiché.<br>',

'HELP_ARTICLE_PICTURES_THUMB'                   =>  'Les vignettes sont de petites images produit. Elles sont principalement utilisées dans les listes produits (catégories, résultats de recherche).<br>' .
                                                    'Transférer une image vignette remplacera l\'image actuelle générée depuis la première image produit.<br>' .
                                                    'Après transfert, le nom de l\'image est affiché dans vignette. Si aucune vignette n\'a été transférée, --- est affiché.<br>',

'HELP_ARTICLE_PICTURES_PIC1'                    =>  'Les visuels produits sont utilisés dans la fiche produit. Vous pouvez transférer jusqu\'à 7 images par produit. Après transfert, le nom de l\'image est affiché dans le champ correspondant. Si aucune image n\'a été transférée, --- est affiché.<br>' .
                                                    'Transférez des visuels de grande résolution.  Après le transfert, l\'image principale, l\'image Zoom, la vignette et l\'icône seront générées automatiquement.',
...
'HELP_ARTICLE_PICTURES_ZOOM1'                   =>  'Les images Zomm sont des visuels de grande taille qui sont accessibles depuis la fiche produit. </br>' .
                                                    'Vous pouvez transférer des images Zoom dans <span class="navipath_or_inputname">Zoom X upload</span>. Après transfert, le nom de l\'image est affiché dans <span class="navipath_or_inputname">Zoom X</span> . Si aucune image Zoom n\'a été transférée, <span class="userinput_or_code">nopic.jpg</span> est affiché.<br>',

'HELP_ARTICLE_STOCK_STOCKFLAG'                  =>  'Dans <span class="navipath_or_inputname">Type de stock</span> vous pouvez choisir parmi 4 possibilités:' .
                                                    '<ul><li><span class="userinput_or_code">Standard</span>: Le produit peut être commandé même si pas de stock disponible.</li>' .
                                                    '<li><span class="userinput_or_code">Entrepôt Externe</span>: Le produit peut toujours être commandé et sera toujours affiché <span class="filename_filepath_or_italic">En stock</span>.</li>' .
                                                    '<li><span class="userinput_or_code">Si hors stock, ne pas afficher</span>: Le produit n\'est pas affiché aux clients lorsque pas de stock disponible.</li>' .
                                                    '<li><span class="userinput_or_code">Si hors stock, pas de commande possible</span>: Le produit est affiché aux clients mais la commande n\'est pas possible.</li></ul>',
...
'HELP_CATEGORY_MAIN_PARENTID'                   =>  'Dans <span class="navipath_or_inputname">Sous-catégorie de</span> définissez la hiérarchie de votre catégorie, à quel endroit sera affichée cette catégorie :<br>' .
                                                    '<ul><li>Si la categorie est une catégorie principale (niveau 1), alors sélectionnez <span class="userinput_or_code">--</span>.</li>' .
                                                    '<li>Si la categorie est une sous-catégorie d\'une autre catégorie, alors sélectionnez cette catégorie "parente" dans la liste.</li></ul>',
...
'HELP_DELIVERY_MAIN_COUNTRULES'                 =>  'Dans <span class="navipath_or_inputname">Règles de calcul</span> vous sélectionnerez comemnt le prix est calculé:' .
                                                    '<ul><li><span class="userinput_or_code">Une fois par panier</span>: Le prix est calculé une fois pour toute la commande.</li>' .
                                                    '<li><span class="userinput_or_code">Une fois pour chaque type de produit différent</span>: Le prix est calculé pour chaque produit différent dans le panier, Quelle que soit la quantité commandée.</li>' .
                                                    '<li><span class="userinput_or_code">Pour chaque produit</span>: Le prix est calculé pour chaque unité de produit dans le panier.</li></ul>',

'HELP_DELIVERY_MAIN_CONDITION'                  =>  'Dans <span class="navipath_or_inputname">Condition</span> vous pouvez spécifier que les règles de calcul des coûts de transport s\'appliquent seulement sous certaines conditions. 4 conditions sont possibles:' .
                                                    '<ul><li><span class="userinput_or_code">Nombre de produits</span>: Nombre de produits dans le panier.</li>' .
                                                    '<li><span class="userinput_or_code">Dimensions</span>: Dimensions totales des produits. Pour que ce paramètre soit valable, vous devrez renseigner les dimensions de vos produits.</li>' .
                                                    '<li><span class="userinput_or_code">Poids</span>: Poids total de la commande en Kgs. Pour que ce paramètre soit valable, vous devrez renseigner le poids de vos produits.</li>' .
...
'HELP_DELIVERY_MAIN_PRICE'                      =>  'Vous pouvez utiliser <span class="navipath_or_inputname">Prix : frais/rabais</span> pour définir le coût de transport. Le prix peut être calculé de 2 manières différentes:' .
                                                    '<ul><li>Avec <span class="userinput_or_code">abs</span>, le prix est exprimé en valeur absolue (ex: avec <span class="userinput_or_code">6,90</span>, un prix de 6.90 € est appliqué).</li>' .
                                                    '<li>Avec <span class="userinput_or_code">%</span>,  prix est exprimé en valeur relative par rapport au prix de vente (ex: avec <span class="userinput_or_code">10</span>, un prix de 10% du montant de commande est appliqué).</li></ul>',
...
'HELP_DISCOUNT_MAIN_REBATE'                     =>  'Dans <span class="navipath_or_inputname">Promotions</span>, vous pouvez définir le niveau de vos réductions. La liste de choix sous le champ remise vous permet de choisir entre une réduction en valeur absolue ou relative:' .
                                                    '<ul>' .
                                                    '<li><span class="userinput_or_code">abs</span>: Réduction absolue, ex: 5€.</li>' .
                                                    '<li><span class="userinput_or_code">%</span>: Pourcentage de réduction, ex: 10% du prix de vente.</li>' .
                                                    '</ul>',
...
'HELP_PAYMENT_MAIN_AMOUNT'                      =>  'Vous pouvez utiliser le <span class="navipath_or_inputname">Montant de commande</span> pour définir l\'accès aux moyens de paiement. Les champs <span class="navipath_or_inputname">de</span> et <span class="navipath_or_inputname">à</span> vous permettent de renseigner une fourchette de montants.<br>' .
                                                    'Si vous soiuhaitez qu\'un moyen de paiement soit toujours disponible, vous devez définir une condition qui sera toujours remplie: Saisissez <span class="userinput_or_code">0</span> dans le champ <span class="navipath_or_inputname">de</span>  et <span class="userinput_or_code">99999999</span> dans le champ <span class="navipath_or_inputname">à</span>.',
...
'HELP_PAYMENT_MAIN_ADDPRICE'                    =>  'Le paramètre <span class="navipath_or_inputname">Frais supplémentaires/Réduction</span>, permet de différencier les prix en fonction des moyens de paiement. Le prix peut être défini de deux manières différentes:' .
                                                    '<ul><li>Avec <span class="userinput_or_code">abs</span> le prix est saisi en valeur absolue pour le moyen de paiement (ex: Si vous saisissez <span class="userinput_or_code">7.50</span> un surcoût de 7.50 € est appliqué.)</li>' .
                                                    '<li>Avec <span class="userinput_or_code">%</span>, le prix est calculé sur la base du prix de vente (ex: Si vous saisissez <span class="userinput_or_code">2</span>, un surcoût de 2% est appliqué au prix de vente)</li></ul>',
...
'HELP_USER_MAIN_HASPASSWORD'                    =>  'Vous pouvez ici identifier si les utilisateurs se sont enregistrés pour passer commande:' .
                                                    '<ul><li>Si un mot de passe a été défini, l\'utilisateur s\'est enregistré.</li>' .
                                                    '<li>Sinon, il a passé commande sans créer de compte client.</li></ul>',
...
'HELP_USER_EXTEND_DISABLEAUTOGROUP'             =>  'Par défaut, les utilisateurs sont automatiquement assignés à certains groupes d\'utilisateurs. Si vous ne souhaitez pas ce mode de fonctionnement, activez ce paramètre.',
...
'HELP_VOUCHERSERIE_MAIN_DISCOUNT'               =>  'Dans <span class="navipath_or_inputname">Promotions</span>, vous définissez la valeur de vos promotions. Vous pouvez utiliser la liste de sélection ci-après pour définir le type de réduction souhaitée (Absolue/Relative):' .
                                                    '<ul>' .
                                                    '<li><span class="userinput_or_code">abs</span>: Réduction en valeur absolue, ex: 5 €.</li>' .
                                                    '<li><span class="userinput_or_code">%</span>: Réduction en pourcentage, ex: 10% du prix de vente.</li>' .
                                                    '</ul>',
...
'HELP_DYN_TRUSTED_RATINGS_ID'                   => 'Vous recevrez votre identifiant Trusted Shops dans votre eMail de confirmation de commande. Si vous êtes déjà cleint Trusted Shops, veuillez utiliser votre identifiant actuel. L\'indicateur vert indique que l\'évaluation des clients a bien été vérifiée et activée.',
'HELP_DYN_TRUSTED_RATINGS_WIDGET'               => 'Activer le widget de notation client.',
'HELP_DYN_TRUSTED_RATINGS_THANKYOU'             => 'Activer le bouton "Donnez votre avis!" dans l\'email "Commande validée".',
'HELP_DYN_TRUSTED_RATINGS_ORDEREMAIL'           => 'Activer le bouton "Donnez votre avis!" dans l\'email "Commande confirmée".',
'HELP_DYN_TRUSTED_RATINGS_ORDERSENDEMAIL'       => 'Activer le bouton "Donnez votre avis!" dans l\'email "Commande expédiée".',
'HELP_DYN_TRUSTED_TSID'                         => 'Identifiant Trusted Shops pour la boutique (pour langage).',
'HELP_DYN_TRUSTED_USER'                         => 'Un nom d\'utilisateur (wsUser) est obligatoire pour le Webservice Trusted Shops si vous souhaitez activer la protection des acheteurs Trusted Shops Excellence. La protection des acheteurs Classique ne nécessite pas de nom d\'utilisateur.',
'HELP_DYN_TRUSTED_PASSWORD'                     => 'Un mot de passe (wsPassword) est obligatoire pour le Webservice Trusted Shops si vous souhaitez activer la protection des acheteurs Trusted Shops Excellence. La protection des acheteurs Classique ne nécessite pas de mot de passe.',
'HELP_DYN_TRUSTED_TESTMODUS'                    => 'Environnement de test ("Sandbox") activé. Une fois la procédure de certification Trusted Shops terminée, Trusted Shops vous enverra un eMail avec vos information d\'identification.',
'HELP_DYN_TRUSTED_ACTIVE'                       => 'Activez cette option pour afficher le label Trusted Shops sur la boutique.',
'HELP_DYN_TRUSTED_TSPAYMENT'                    => 'Définir les moyens de paiement aux modes de paiement appropriés de Trusted Store.',
