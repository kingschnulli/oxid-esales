    ...
    <form name="login" class="oxValidate" action="[{ $oViewConf->getSslSelfLink() }]" method="post">
        ...
        <ul class="form clear">
            <li [{if $aErrors}]class="oxError"[{/if}]>
                ...
                <input class="oxValidate oxValidate_notEmpty" type="text" name="lgn_usr" value="" size="37" >
            ...
            <li [{if $aErrors}]class="oxError"[{/if}]>
                ...
                <input class="oxValidate oxValidate_notEmpty textbox" type="password" name="lgn_pwd" value="" size="37">
                <p class="oxValidateError">
                    <span class="oxError_notEmpty">[{ oxmultilang ident="EXCEPTION_INPUT_NOTALLFIELDS" }]</span>
                </p>
            </li>
...
<div class="col">
    <a href="[{ oxgetseourl ident=$oViewConf->getSslSelfLink()|cat:"cl=register" }]" class="textLink" rel="nofollow">[{ oxmultilang ident="FORM_LOGIN_ACCOUNT_OPENACCOUNT" }]</a><br />
    <a href="[{ oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=forgotpwd" }]" class="textLink" rel="nofollow">[{ oxmultilang ident="FORM_LOGIN_ACCOUNT_FORGOTPWD" }]</a>
</div>
