[{if $oView->showZoomPics()}]
    ...
    <div id="zoomModal" class="popupBox corners FXgradGreyLight glowShadow overlayPop">
        ...
        <div class="zoomed">
            <img class="ox-zoomimg" src="[{$aZoomPics[$iZoomPic].file}]" alt="[{$oDetailsProduct->oxarticles__oxtitle->value|strip_tags}] [{$oDetailsProduct->oxarticles__oxvarselect->value|default:''}]" id="zoom_img">
        </div>
