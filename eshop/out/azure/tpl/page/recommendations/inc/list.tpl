            ...
            <li>
                <div class="recommendations">
                    <div class="title clear">
                        <a href="[{ oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl="|cat:$oViewConf->getActiveClassName()|cat:"&amp;fnc=editList" params="recommid=`$recommlist->oxrecommlists__oxid->value`&amp;searchrecomm=`$searchrecomm`" }]" class="title" title="[{ $recommlist->oxrecommlists__oxtitle->value}]">[{ $recommlist->oxrecommlists__oxtitle->value }]</a></b>: [{ oxmultilang ident="PAGE_RECOMMENDATIONS_PRODUCTS_LISTBY" }] [{ $recommlist->oxrecommlists__oxauthor->value }]
