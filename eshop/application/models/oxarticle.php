 ...
 * @version   SVN: $Id: oxarticle.php 49950 2012-10-01 15:47:11Z vilma $
 */
...
class oxArticle extends oxI18n implements oxIArticle, oxIUrl
{
    ...
    public function getBasketPrice( $dAmount, $aSelList, $oBasket )
    {
        ...
        $oBasketPrice = $this->_getPriceObject();
    ...
    protected function _preparePrice( $dPrice, $dVat )
    {
        ...
        if ( $this->_isPriceViewModeNetto() && !$blEnterNetPrice ) {
            $dPrice = round( oxPrice::brutto2Netto( $dPrice, $dVat ), 2 );
        } elseif ( !$this->_isPriceViewModeNetto() && $blEnterNetPrice ) {
    ...
    public function getVarMinPrice()
    {
        ...
        $oPrice = null;
        if ( $this->_hasAnyVariant() && $this->oxarticles__oxvarminprice->value ) {
            $dPrice = $this->_preparePrice( $this->oxarticles__oxvarminprice->value, $this->getArticleVat() );
            $oPrice = $this->_getPriceObject();
