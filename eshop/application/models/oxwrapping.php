 ...
 * @version   SVN: $Id: oxwrapping.php 48727 2012-08-16 09:09:02Z tomas $
 */
...
class oxWrapping extends oxI18n
{
    ...
    {
        return oxRegistry::getLang()->formatCurrency( $this->getWrappingPrice()->getBruttoPrice(), $this->getConfig()->getActShopCurrencyObject() );
    }
