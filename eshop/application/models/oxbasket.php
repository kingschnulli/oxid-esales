 ...
 * @version   SVN: $Id: oxbasket.php 49994 2012-10-02 12:23:30Z linas.kukulskis $
 */
 ...
 //P
    ...
    protected function _applyDiscounts()
    {
        ...
        if ( $oPriceList = $this->getDiscountProductsPrice() ) {
            $dBruttoPrice = $oPriceList->getSum( $this->isCalculationModeNetto() );
        ...
        if ( $dBruttoPrice &&
             ( ( $oTotalDiscount && $oTotalDiscount->getPrice() ) ||
        ...
        // calculation of tatal netto/bruto sum
        // vat sum
