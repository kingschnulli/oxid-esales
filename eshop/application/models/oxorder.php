 ...
 * @version   SVN: $Id: oxorder.php 48786 2012-08-17 10:20:42Z tomas $
 */
...
class oxOrder extends oxBase
{
    ...
    protected function _loadFromBasket( oxBasket $oBasket )
    {
        ...
        $this->oxorder__oxtotalnetsum   = new oxField(oxRegistry::getUtils()->fRound($oBasket->getDiscountedNettoPrice()), oxField::T_RAW);
