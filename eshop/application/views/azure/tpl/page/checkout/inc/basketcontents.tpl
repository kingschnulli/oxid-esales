             ...
             [{if $oViewConf->getShowGiftWrapping() }]
                  ...
                  [{ if $oCard }]
                    <tr>
                      ...
                      <td id="orderCardPrice" class="unitPrice">[{ $oCard->getFPrice() }]&nbsp;[{ $currency->sign }]</td>
                      <td class="vatPercent">[{if $oxcmp_basket->getWrappCostVat() }][{ $oxcmp_basket->getWrappCostVatPercent() }]%[{/if}]</td>
