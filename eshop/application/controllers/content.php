 ...
 * @version   SVN: $Id: content.php 48786 2012-08-17 10:20:42Z tomas $
 */
...
class Content extends oxUBase
{
    ...
    */
    ...
    {
        return oxRegistry::get("oxUtilsView")->parseThroughSmarty( $this->getContent()->oxcontents__oxcontent->value );
    }
