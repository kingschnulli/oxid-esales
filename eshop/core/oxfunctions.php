 ...
 * @version   SVN: $Id: oxfunctions.php 48727 2012-08-16 09:09:02Z tomas $
 */
...
function oxAutoload( $sClass )
{
    ...
    if (!$aClassPaths) {
        //removed due to #2931
        //$aClassPaths = oxRegistry::getUtils()->fromPhpFileCache("class_file_paths");
    }
    ...
    if ( !in_array( $sClass, $aTriedClasses ) ) {
        //$aModules = oxRegistry::getConfig()->getConfigParam( 'aModules' );
        $aModules = oxUtilsObject::getInstance()->getModuleVar( 'aModules' );
