 ...
 * @version   SVN: $Id: oxsession.php 50216 2012-10-05 15:02:31Z saulius.stasiukaitis $
 */
...
class oxSession extends oxSuperCfg
{
    ...
    public function isSidNeeded( $sUrl = null )
    {
        ...
        if ( $sUrl && $this->_getSessionUseCookies() && $this->_getCookieSid() && !$oConfig->isCurrentProtocol($sUrl) ) {
