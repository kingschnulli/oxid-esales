 ...
 * @version   SVN: $Id: oxsession.php 48869 2012-08-21 08:10:48Z tomas $
 */
...
class oxSession extends oxSuperCfg
{
    ...
    public function initNewSession()
    {
        ...
        self::setVar( "sessionagent", oxRegistry::get("oxUtilsServer")->getServerVar( 'HTTP_USER_AGENT' ) );
    }
    ...
    {
        return ( !oxRegistry::getUtils()->isSearchEngine() ) && ( (( bool ) $this->getConfig()->getConfigParam( 'blForceSessionStart' )) || oxConfig::getParameter( "su" ) || $this->_blForceNewSession );
    }
    ...
    protected function _allowSessionStart()
    {
        ...
        if ( !$this->isAdmin() ) {
            if ( oxRegistry::getUtils()->isSearchEngine() || oxConfig::getParameter( 'skipSession' ) ) {
