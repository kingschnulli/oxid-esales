 ...
 * $Id: oxmanufacturer.php 23930 2009-11-10 17:29:24Z arvydas $
 */
...
class oxManufacturer extends oxI18n implements oxIUrl
{
    ...
    public function getBaseStdLink( $iLang, $blAddId = true )
    {
        ...
        $sUrl = $this->getConfig()->getShopHomeUrl( $iLang, false ) . 'cl=manufacturerlist';
        return $sUrl . ( $blAddId ? '&amp;mnid='.$this->getId() : '' );
    }
