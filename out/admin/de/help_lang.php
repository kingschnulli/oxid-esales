...
'HELP_ARTICLE_STOCK_STOCKFLAG'					=>	"Hier können Sie einstellen, wie sich der eShop verhält, wenn der Artikel ausverkauft ist:<br />" .
													...
													'<li>Fremdlager: Der Artikel kann immer gekauft werden und wird immer als "auf Lager" angezeigt. (In einem Fremdlager kann der Lagerbestand nicht ermittelt werden. Deswegen wird der Artikel immer als â€žauf Lagerâ€œ geführt).</li>' .
