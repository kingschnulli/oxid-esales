 ...
 * $Id: help_lang.php 15938 2009-01-27 14:14:30Z philipp.grashoff $
 */
...
'HELP_SHOP_SYSTEM_DISABLENAVBARS' 				=>	"Wenn diese Einstellung aktiv ist, werden im Bestellprozess folgende Elemente ausgeblendet: Kategoriennavigation, Artikelsuche, Warenkorb und Newsletteranmeldung. Dadurch werden die Benutzer während des Bestellprozesses nicht von diesen Elementen abgelenkt.",
...
'HELP_SHOP_SYSTEM_AUTOSAVE'						=>	"Wenn diese Einstellung aktiv ist, dann werden alle Änderungen in Administrationsbereich automatisch gespeichert, wenn Sie zu einer anderen Registerkarte wechseln. Wenn die Einstellung nicht aktiv ist, dann werden die Änderungen nur gespeichert, wenn Sie auf <var>Speichern</var> klicken.",   
...
/*'HELP_SHOP_CONFIG_EXCLUDENONMATERIALPRODUCTS'	=>	"Sie können einen Artikel als immatriell markieren",*/
...
'HELP_CATEGORY_MAIN_PRICEFROMTILL'				=>	"Mit <var>Preis von/bis</var> können Sie einstellen, dass in der Kategorie nur die zugeordneten Artikel angezeigt werden, die einen bestimmten Preis haben. Im ersten Eingabefeld wird die Untergrenze eingegeben, in das zweite Eingabefeld die Obergrenze.<br>" .
...
'HELP_SELECTLIST_MAIN_IDENTTITLE'				=>	"Bei <var>Arbeitstitel</var> können Sie einen zusätzlichen Titel eingeben, der den Benutzern Ihres eShops nicht angezeigt wird. Sie können den Arbeitstitel dazu verwenden um ähnliche Auswahllisten zu unterscheiden (z. B. <i>Größe für Hosen</i> und <i>Größe für Hemden</i>).<var>",					
...
'HELP_VENDOR_MAIN_ICON'							=>	"Bei <var>Icon</var> und <var>Hersteller-Icon hochladen</var> können Sie ein Bild für den Hersteller hochladen (z. B. das Logo des Herstellers). Wählen Sie bei <var>Hersteller-Icon hochladen</var> das Bild aus, das Sie hochladen möchten. Wenn Sie auf Speichern klicken, wird das Bild hochgeladen. Nachdem das Bild hochgeladen ist, wird der Dateiname des Bildes in <var>Icon</var> angezeigt.",



'HELP_VENDOR_SEO_FIXED'							=>	"Sie können die SEO URLs vom eShop neu berechnen lassen. Eine Herstellerseite bekommt z. B. eine neue SEO URL, wenn Sie den Titel des Herstellers ändern. Die Einstellung <var>URL fixiert</var> unterbindet das: Wenn sie aktiv ist, wird die alte SEO URL beibehalten und keine neue SEO URL berechnet.",

'HELP_VENDOR_SEO_SHOWSUFFIX'					=>	"Diese Einstellung bestimmt, ob das Suffix für den Fenstertitel angezeigt wird, wenn die Herstellerseite im eShop aufgerufen wird. Das Titel Suffix können Sie unter <em>Stammdaten -> Grundeinstellungen -> SEO -> Titel Suffix</em> einstellen.",

'HELP_VENDOR_SEO_KEYWORDS'						=>	"Diese Stichwörter werden in den HTML-Quelltext (Meta Keywords) eingebunden. Diese Information wird von Suchmaschinen ausgewertet. Hier können Sie passende Stichwörter zu dem Hersteller eingeben. Wenn Sie nichts eingeben, werden die Stichwörter automatisch erzeugt.",

'HELP_VENDOR_SEO_DESCRIPTION'					=>	"Dieser Beschreibungstext wird in den HTML-Quelltext (Meta Description) eingebunden. Dieser Text wird von vielen Suchmaschinen bei den Suchergebnissen angezeigt. Hier können Sie eine passende Beschreibung für den Hersteller eingeben. Wenn Sie nichts eingeben, wird die Beschreibung automatisch erzeugt.",
