...
'HELP_SHOP_SYSTEM_AUTOSAVE'						=>	"If this setting is checked, all changes in eShop admin are saved automatically when you go to another tab. If the setting is unchecked, changes are only saved when clicking the <var>Save</var> buttons.",   
...
'SHOP_SEO_MAINLANGUAGE'							=>	"Here you can set the default language for SEO URLs. In the default language, no language token is is inserted in the SEO URL, e. g. www.youreshop.com/category/product.html. In all other languages a language token is added, e. g. www.youreshop.com/de/category/product.html.",
