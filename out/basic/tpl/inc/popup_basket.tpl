<div id="wait" class="popup">
    ...
    <div>
        ...
        <input id="test_popupCart" type="submit" class="bl disabled" value="[{ oxmultilang ident="BASKET_POPUP_FULL_DISPLAYCART" }]" disabled="disabled">
        [{/oxhasrights}]
        <input id="test_popupContinue" type="button" class="br" value="[{ oxmultilang ident="BASKET_POPUP_FULL_CONTINUESHOPPING" }]" onclick="oxid.popup.hide();return false;">
    </div>
    </form>
</div>
