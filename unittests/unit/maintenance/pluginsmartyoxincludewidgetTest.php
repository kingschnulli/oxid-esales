 ...
 * @version   SVN: $Id: pluginsmartyoxincludewidgetTest.php 48636 2012-08-13 14:28:17Z linas.kukulskis $
 */
...
class Unit_Maintenance_pluginSmartyoxIncludeWidgetTest extends OxidTestCase
{
    public function testIncludeIfHTMLCachingIsOn()
    {
        ...
        $sForceSid = "";
        $sId = oxSession::getInstance()->getId();
        if ($sId) {
            $sForceSid = "&amp;force_sid=" . $sId;
        }

        $oSmarty = new smarty();
        $sOutput = "<esi:include src='". $this->getConfig()->getWidgetUrl() ."cl=oxwtagcloud&amp;blShowTags=1" . $sForceSid . "&amp;lang=". $sLang ."'>";
