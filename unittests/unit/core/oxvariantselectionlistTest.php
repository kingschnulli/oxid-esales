...
class Unit_Core_oxvariantselectionlistTest extends OxidTestCase
{
    /**
    ...
    {
        $oSelectionList = new oxVariantSelectionList( "test", 0 );
        ...
        $this->assertFalse( $oSelectionList->allowsToBuy( false ) );
        $this->assertFalse( $oSelectionList->allowsToBuy( false ) );
        ...
        $this->assertFalse( $oSelectionList->allowsToBuy( false ) );
        $this->assertTrue( $oSelectionList->allowsToBuy( true ) );
    }
}