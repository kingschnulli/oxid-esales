 ...
 * @version   SVN: $Id: oxlocatorTest.php 44219 2012-04-23 15:40:00Z linas.kukulskis $
 */
...
class Unit_Views_oxlocatorTest extends OxidTestCase
{
    ...
    public function testSetListLocatorData()
    {
        ...
        $oLocatorTarget->expects( $this->once() )->method( 'getSortingSql')->with( $this->equalTo( "category" ) )->will( $this->returnValue( 'oxid' ) );
