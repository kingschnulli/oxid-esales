...
class Unit_Views_oxcmpCategoriesTest extends OxidTestCase
{
    ...
    public function testInitLoadCategoryTree()
    {
        ...
        $oCfg->expects( $this->at( 3 ) )->method( 'getConfigParam' )->with($this->equalTo('bl_perfLoadCatTree'))->will( $this->returnValue( true ));
    ...
    public function testLoadCategoryTree()
    {
        ...
        $oParent->expects($this->once())->method('setActiveCategory')
                ->with(
    ...
    public function testRenderEverythingOff()
    {
        $oCfg = $this->getMock('stdClass', array('getConfigParam'));
        $oCfg->expects( $this->at( 0 ) )->method( 'getConfigParam' )->with($this->equalTo('bl_perfLoadManufacturerTree')) ->will( $this->returnValue( false ));
        $oCfg->expects( $this->at( 1 ) )->method( 'getConfigParam' )->with($this->equalTo('bl_perfLoadCatTree')) ->will( $this->returnValue( false ));
    ...
    public function testRenderCategoryList()
    {
        $oCfg = $this->getMock('stdClass', array('getConfigParam'));
        $oCfg->expects( $this->at( 0 ) )->method( 'getConfigParam' )->with($this->equalTo('bl_perfLoadManufacturerTree')) ->will( $this->returnValue( false ));
        $oCfg->expects( $this->at( 1 ) )->method( 'getConfigParam' )->with($this->equalTo('bl_perfLoadCatTree')) ->will( $this->returnValue( true ));
        $oCfg->expects( $this->at( 2 ) )->method( 'getConfigParam' )->with($this->equalTo('bl_perfLoadTreeForSearch')) ->will( $this->returnValue( false ));
    ...
    public function testRenderCategoryListLoadSearch()
    {
        ...
        $oCfg->expects( $this->at( 0 ) )->method( 'getConfigParam' )->with($this->equalTo('bl_perfLoadManufacturerTree')) ->will( $this->returnValue( false ));
        $oCfg->expects( $this->at( 1 ) )->method( 'getConfigParam' )->with($this->equalTo('bl_perfLoadCatTree')) ->will( $this->returnValue( true ));
        $oCfg->expects( $this->at( 2 ) )->method( 'getConfigParam' )->with($this->equalTo('bl_perfLoadTreeForSearch')) ->will( $this->returnValue( true ));

        $oCTree  = $this->getMock('stdClass', array());

        $oParent = $this->getMock('stdClass', array( 'getManufacturerTree', 'setSearchCatTree'));
        $oParent->expects( $this->never() )->method( 'getManufacturerTree' );
        $oParent->expects( $this->at(0) )->method( 'setSearchCatTree' )->with($this->equalTo($oCTree));
