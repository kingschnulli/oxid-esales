 ...
 * @version   SVN: $Id: oxviewconfigTest.php 48251 2012-08-03 17:06:32Z vilma $
 */
...
class Unit_Views_oxviewConfigTest extends OxidTestCase
{
    ...
    public function testGetLogoutLink()
    {
        ...
        $this->assertEquals('shopHomeUrl/cl=actionclass&amp;cnid=catid&amp;anid=anid&amp;searchparam=searchparam&amp;searchtag=searchtag&amp;listtype=listtype&amp;fnc=logout&amp;tpl=tpl&amp;oxloadid=oxloadid&amp;redirect=1', $oVC->getLogoutLink());
    ...
    {
        modConfig::setParameter( "oxloadid", 123 );
