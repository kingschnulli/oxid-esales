            ...
            '<div id="content">' +
                '<div id="selectList" class="dropDown">' +
                    ...
                    '<ul class="drop vardrop FXgradGreyLight shadow">' +
                        '<li class=""><a class="selected" href="#" rel="cda7a650c5856cf2f6738072447d7825">gray</a></li>' +
                        '<li class=""><a id="val2" class="" href="#" rel="fe01d67a002dfa0f3ac084298142eccd">orange</a></li>' +
                    '</ul>' +
                '</div>' +
            '</div>'
        );
