...
class AcceptanceInternational_internationalTest extends oxidAdditionalSeleniumFunctions
{
 ...
 // -------------------------- Selenium tests for UTF-8 shop version ---------------------------
    ...
    public function testFrontendTagsUtf8()
    {
        ...
        $this->assertTrue($this->isElementPresent("test_sortTop_Title_asc"));
        ...
        $this->assertFalse($this->isElementPresent("test_cntr_3"));
        $this->clickAndWait("test_sortTop_Price_asc");
        $this->assertEquals("Page 1 / 2", $this->getText("test_listXofY_Top"));
        $this->assertEquals("Test product 0 [EN] šųößлы", $this->getText("test_title_action_1000"));
        ...
        $this->clickAndWait("test_sortTop_Title_asc");
    ...
    public function testFrontendSearchUtf8()
    {
        ...
        $this->type("//input[@id='f.search.param']", "100");
        $this->select("searchcnid", "index=8");
        ...
        $this->selectAndWait("searchcnid", "index=7");
    ...
    public function testFrontendOrderSteps4And5Utf8()
    {
        ...
        $this->clickAndWait("test_PaymentNextStepBottom");
        $this->assertEquals("Shipping Address companyįÄк Mr firstįÄк lastįÄк streetįÄк 1 3000 cityįÄк Germany Phone:", $this->clearString($this->getText("test_orderShipAdress")));
