 ...
 */
$aData = array(
//test is mark as shipped because need to check why calculation  is not corect, if price is 102 and discount is 5 abs for product, calculation for product total should be 102-5=97.
