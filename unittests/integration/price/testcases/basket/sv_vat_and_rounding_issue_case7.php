<?php
/*
 * 5 products with different vat. Payment, shipping, greeting card and wrapping fees.  Calculate VAT proportionately . Bruto-Bruto mode. Additiona products Bruto-Neto.
*/
$aData = array(
    // Product
    'articles' => array (
    ...
    'options' => array (
        ...
        'config' => array(
            ...
            'sAdditionalServVATCalcMethod' => 'proportional'//W:true,
        ),
        // Other options
