...
INSERT INTO `oxconfig` VALUES ('8563fba1c39372fb6.25074726', 'oxbaseshop', 'blUseDifferentDynDirs', 'bool', 0x7900fdf51e);
...
INSERT INTO `oxcontents` VALUES ('29642e0a7f80ac2f8.33161751', 'oxorderaddinfo', 'oxbaseshop', '1', '0', '1', '1', '', 'Abschließende Informationen', '<div>Beispieltext: </div>\r\n<div>&nbsp;</div>\r\n<div>Ihre IP-Adresse ist [{ $iplog }]<br>\r\n</div>\r\n<div style="background-image: url(''[{$shop->imagedir}]/linedot.gif'')" class="dottedline">&nbsp;</div>\r\n<div><strong>Abschließende Informationen:</strong><br>\r\n<br>\r\n<strong>Korrektur von Eingabefehlern:</strong><br>\r\nBitte überprüfen Sie noch einmal Ihre Angaben. Über die Links der einzelnen Bestellschritte (1 bis 4) können Eingabefehler korrigiert werden.<br>\r\n<br>\r\n<strong>Zeitpunkt des Vertragsschlusses:</strong><br>\r\n</div>\r\n<div style="margin: 0cm 0cm 0pt" class="MsoNormal">Die Darstellung der Produkte im Online-Shop stellt kein rechtlich bindendes Angebot, sondern einen unverbindlichen Online-Katalog dar. Nach Eingabe Ihrer persönlichen Daten und durch Anklicken des Buttons <strong>&quot;Bestellung absenden&quot;</strong> im abschließenden Schritt des Bestellprozesses geben Sie eine verbindliche Bestellung der im Warenkorb enthaltenen Waren ab. Die Bestätigung des Eingangs der Bestellung folgt unmittelbar nach dem Absenden der Bestellung. Der Kaufvertrag kommt mit unserer Auftragsbestätigung oder Lieferung der Waren zustande. </div>\r\n<div style="margin: 0cm 0cm 0pt" class="MsoNormal">&nbsp;</div>\r\n<div style="margin: 0cm 0cm 0pt" class="MsoNormal"><a href="[{$shop->selflink}]cl=info&tpl=rightofwithdrawal.tpl"><strong>Widerrufsrecht:</strong></a></div>\r\n<div><span style="color: #0000ff;">---F<span class="596095014-13042007">ügen Sie hier Informationen zur Widerrufsbelehrung ein---</span></span> </div>', 'final note', '<div>\r\n<div><strong>Notice for Shop Administrator:</strong></div>\r\n<div><strong>&nbsp;</strong></div>\r\n<div>Update this text easily and comfortable in the Admin with a WYSYWYG-Editor.<strong>&nbsp;</strong></div>\r\n<div>&nbsp;</div>\r\n<div>Admin Menu: Customer Info -> CMS Pages -> final note</div></div>', '1', '', '', '1', '', '', '8a142c3e4143562a5.46426637', 'CMSFOLDER_USERINFO');
...
INSERT INTO `oxshops` VALUES ('oxbaseshop', 1, 1, 1, 1, 0, '', 0, 'OXID eShop 4', 'OXID Geschenke Shop', 'OXID Gift Shop', '', '', 'online kaufen', 'buy online', '', '', 'Originelle, witzige Geschenkideen - Lifestyle, Trends, Accessoires', 'Gift Ideas - Original, Funny Presents - Lifestyle, Trends, Accessories', '', '', 'Ihre Info e-Mail Adresse', 'Ihre Bestell Reply e-Mail Adresse', 'Ihre Bestell e-Mail Adresse', 'Ihre Bestellung bei OXID eSales', 'Vielen Dank für Ihre Registrierung im OXID eShop', 'Ihr Passwort im OXID eShop', 'Ihre OXID eSales Bestellung wurde versandt', 'Ihre Bestellung bei OXID eSales', 'Vielen Dank für Ihre Registrierung im OXID eShop', 'Ihr Passwort im OXID eShop', 'Ihre OXID eSales Bestellung wurde versandt', '', '', '', '', '', '', '', '', 'Tragen Sie bitte hier Ihren SMTP Server ein', '', '', 'Ihr Firmenname', 'Musterstr. 10', '79098', 'Musterstadt', 'Deutschland', 'Volksbank Musterstadt', '1234567890', '900 1234567', 'DE651234567', '', '', 'Hans', 'Mustermann', '0800 1234567', '0800 1234567', 'www.meineshopurl.com', '8a142c3e60a535f16.78077188', '', '', '', '', '', '', '', 'CE', '4.0.0.0', 1, 1, 0, 0);
